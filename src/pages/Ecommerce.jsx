...
import { StackedEcom, Pie, Button, SparkLine } from '../components';
  ...
  return (
    <div className='mt-12'>
      <div className='flex flex-wrap lg:flex-nowrap justify-center'>
        ...
        h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero bg-no-repeat bg-cover bg-center'>
        <div className='flex justify-between items-center'>
          <div>
            <p className='font-bold text-gray-400'>Earnings</p>
            <p className='text-2xl'>128,435.92</p>
          </div>
        </div>
        <div className='mt-6'>
          <Button 
      ...
      <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780">
        <div className='flex justify-between'>
          ...
          <div className='flex items-center gap-4'>
            <p className='flex items-center gap-2 text-gray-600 dark:text-gray-50 hover:drop-shadow-xl'>
